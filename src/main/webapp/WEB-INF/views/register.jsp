			...
			<div class="wrapper fadeInDown">
				<div id="formContent">
					<div class="fadeIn first">
						<h2 class='sign'>Register User!</h2>
						<div>
						<span class='error'>
					...
					<form action="register" method="POST">
						<input type="text" id="login" class="fadeIn second" name="email"
							placeholder="Email" value="sh@g.c" /> <input type="text"
							value="sh" id="username" class="fadeIn third" name="username"
						...
						</select> <input type="submit" class="fadeIn fourth" value="REGISTER" />
					</form>
