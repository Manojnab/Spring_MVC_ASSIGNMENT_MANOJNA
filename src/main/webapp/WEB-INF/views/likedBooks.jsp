		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<Table class="table" action="likedBooks" method="GET">
							<!--  JSP scriplets -->
							<%-- <% 
							...
							<c:forEach items="${likedBooks }" var="likedBooks">
								<tr>
								<td value=${likedBooks }>${likedBooks.getAuthorName() }</td>
								<td value=${likedBooks }>${likedBooks.getBname() }</td>
